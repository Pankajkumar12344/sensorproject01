...
class ModelTrainer:
    ...
    def finetune_best_model(self,
        ...
        try:   
            ...
            fineturned_model =best_model_object.set_params(**best_params)

            return fineturned_model
    ...
    def initiate_model_trainer(self,train_array,test_array):
        ...
        try:
            ...
            logging.info(f"splitting training and testing input and traget feature")
            ...
            best_models =self.finetune_best_model(
            ...
            if best_model_score<0.5:
                raise Exception("no best model found with an accuracy greater than the threashod 0.6")
