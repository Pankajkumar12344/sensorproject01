...
class DataTransformationConfig:
    ...
    transformed_train_file_path =os.path.join(artifacts_dir,'train.npy')

    transformed_train_file_path=os.path.join(artifacts_dir,'test.npy')

    transformed_object_file_path =os.path.join(artifacts_dir,'preprocessor.pkl')
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            imputer_step =('imputer',SimpleInputer(strategy ='constant',fill_value =0))
    ...
    def initiate_data_transformation(self):
       ...
       try:
           ...
           test_arr=np.c[x_test_scaled,np.arange(y_test)]
